...
insert into repertory values (4,'alibaba','Shenzhen');
insert into repertory values (5,'Amazon','Jinan');
insert into repertory values (6,'ebay','Hefei');
insert into repertory values (7,'asus','Yingtan');
